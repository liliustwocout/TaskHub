# Hướng dẫn Test Đặc trưng 3 & 4 (Workspace & Project)
...
### Test 3.1: Tạo Workspace - Thành công
...
### Test 3.2: Xem danh sách Workspace - Thành công
...
### Test 3.3: Xem chi tiết Workspace - Thành công
...
### Test 3.4: Cập nhật Workspace (OWNER only) - Thành công
...
### Test 3.5: Invite Member vào Workspace - Thành công
...
### Test 3.6: Xem danh sách Members - Thành công
...
### Test 3.7: Test phân quyền — Member không được invite - Thất bại
...
### Test 3.8: Test phân quyền — Member không được xóa workspace - Thất bại
...
### Test 3.9: Xóa Member khỏi Workspace - Thành công
...
### Test 4.1: Tạo Project trong Workspace (OWNER) - Thành công
...
### Test 4.2: EDITOR cũng tạo được Project - Thành công
...
### Test 4.3: Danh sách Projects trong Workspace - Thành công
...
### Test 4.4: Chi tiết Project - Thành công
...
### Test 4.5: Cập nhật Project (EDITOR) - Thành công
...
### Test 4.6: Archive Project - Thành công
...
### Test 4.7: EDITOR không được xóa Project - Thất bại
...
### Test 4.8: OWNER xóa Project - Thành công
...
### Test 4.9: VIEWER không tạo/sửa được Project - Thất bại
